...
export const DeleteProductModal = ({ product, setIsOpen }: Props): ReactElement => {
  ...
  return (
    <div data-testid="delete-product-modal" className="fixed top-0 left-0 flex h-full w-full items-center justify-center bg-black bg-opacity-75 shadow-sm">
      <div className="flex h-[21vh] w-[35vh] flex-col justify-between rounded-2xl bg-white p-4 text-center">
        ...
        <div className="flex justify-center">
          <Button data-testid="delete-cancel" size="small" colour="white" className="mr-4 h-[45px] w-[129.5px] border-[1px]" onClick={() => setIsOpen(false)}>
            Cancel
          </Button>
          <Button data-testid="delete-yes" size="small" colour="yellow" className="h-[45px] w-[129.5px]" onClick={removeProductFromLocalOrder}>
            Yes
          </Button>
        </div>
      </div>
